...
qstnr_data_path  <- here("./Data/VRTask/Ratings/Ratings_partially_cleaned.xlsx")
...
fulldata$ID <- as.factor(fulldatda$ID)
...
##### TRIAL-BASED ##### 
#(!) Pawel: - to be decided: Localization Errors or LocalizationErrorsNorm
...
hist(comparison_t$diff_trials, breaks = 20, xlab = "Number of outlier systole lengths", ylab = "Subjects count", main = "", col = "gray40")
