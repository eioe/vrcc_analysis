...
```{r}
# AM (2019-07-21): This will be moved to utility functions

ICC <- function(summary) {
  
  variances = data.frame(summary$varcor)
...
```{r}
# Null model
full_model_1 <- lmer(DistanceError ~ FearObject + (1|ID), 
                     data = fulldata)
