...
qstnr_data <- read_questionnaire_data(qstnr_data_path, sheet = 1, filter_pilot = F)
...
## The  solution below does not work anymornce since sub_lists do not overlapp between behavioral and ecg fulldata 
# subjects_list <- fullfulldata %>%
#                   select(ID) %>%
#                   distinct()

## temporary manual solution (PM) - missing behavioral data for S09, 22, 36 
#subjects_list <- c("S03", "S05", "S06", "S07", "S08", "S10", "S12", "S14", "S15", "S16", "S17", "S19", "S23", "S24", "S26", "S27", "S28", "S29", "S30", "S31", "S32", "S33", "S34", "S35", "S37", "S38", "S39", "S42", "S43", "S45", "S46")

# temporary semi-automated solution (PM) (read sub_list based on ecg files)
...
subjects_list <- subjects_list[!subjects_list %in% c("S09", "S22", "S36")] # remove missing behavioral
