...
# Equivalence package (default arguments)
tost(d$m_systole, d$m_diastole, paired = T, epsilon = 1, var.equal = FALSE, conf.level = 0.95, alpha = NULL) # * epsilon > 2
#https://stats.stackexchange.com/questions/244839/r-what-is-magnitude-of-region-of-similarity-epsilon-when-using-tost-from-e
