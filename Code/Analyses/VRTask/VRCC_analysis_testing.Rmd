...
# HYPOTHESIS 2: Perceived distance to threatening animals presented at systole vs presented at diastole 
...
# DE ~ CP * Threat + (1 + r true | ID) # preregisterd full model
full_model <- lmer(DistanceError ~ c_phase * FearObject + (1 + RealDistance|ID), data = d)
summary(full_model)

## simple (unpreregistered model)
