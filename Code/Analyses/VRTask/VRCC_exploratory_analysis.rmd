...
d_sub_start <- read.csv(file = paste0(VRCC_dir,"/Data/VRTask/VRCC_data_initial_subjective_ratings"))

# read mid-experimental ratings data
d_sub_mid <- read.csv(file = paste0(VRCC_dir,"/Data/VRTask/VRCC_data_mid-experimental_subjective_ratings"))
d_sub_mid$threat[d_sub_mid$threat == 0] <- NA # add NAs

# read questionnaires data
d_qstn <- read.csv(file = paste0(VRCC_dir,"/Data/VRTask/VRCC_data_questionnaires"))
