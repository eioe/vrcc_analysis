...
### NOTE: Code in this notebook is based on the assumption that `relPosRRrad` is the varibale representing `CP` from the pre-reg document. Is this correct, Paweł?
...
# Full model
full_model <- lmer(DistanceError ~ relPosRRradCircSin * FearObject + relPosRRradCircCos * FearObject + (1 + RealDistance|ID), data = d)
summary(full_model)
