...
dd <- data %>% 
  ...
  dplyr::summarize(mean_distance = mean(DistanceError),
                   mean_localization = mean(LocalizationError),
                   mean_angular = mean(AngularErrorRad))
...
d <- data %>% 
  ...
  dplyr::summarize(mean_LocErr = mean(LocalizationError),
                   mean_AngErr = mean(AngularErrorDegAbs),
                   mean_DistErr = mean(DistanceError),
                   sd_LocErr = sd(LocalizationError),
...
# check normality of distributions
shapiro.test(d$mean_LocErr[d$FearObject=="True"])
shapiro.test(d$mean_LocErr[d$FearObject=="False"])
