...
###1. Control analysis: avg. distance and localization errors different from zero?
...
###3.1. Preregistered analysis: hypothesis 1 (compare distance error between threat and non-threat)
d <- data %>% 
  dplyr::group_by(ID) %>%
...
# specify colors
cR <- c_threat  # Old value: rgb(178/255, 31/255, 0/255)
cB <- c_nonthreat  # Old value:  rgb(10/255, 80/255, 200/255)
...
###3.1. Exploratory/control analysis: compare angular error between threat and non-threat
d <- data %>% 
  dplyr::group_by(ID) %>%
