...
d %>% dplyr::group_by(c_phase, FearObject)  %>% 
  dplyr::summarize(DistanceError_m = mean(DistanceError),
                   DistanceError_sd = sd(DistanceError))
...
# save to disc:
fpath_figs <- file.path(VRCC_dir, 'Figures')
